...
Public Class kMasuk
    ...
    Sub tampil()
        ...
        Dim da As New MySqlDataAdapter("SELECT * FROM kas WHERE jenis ='Kas Masuk'", conn)
    ...
    Private Sub tambah_Click(sender As Object, e As EventArgs) Handles tambah.Click
        ...
        If id.Text = "" Then
            Dim myAdapter As New MySqlDataAdapter
            Dim sqlQuery = "INSERT INTO kas(tanggal,jenis,keterangan,jumlah) VALUES('" + tanggal.Value.ToString("yyyy-MM-dd") + "','Kas Masuk','" + keterangan.Text + "','" + jumlah.Text + "')"
